...
// ═══════════════════════════════════════════════════════════════════════════
const VERSION = 'iartcane-2026-08-29a-ho094'; // sync : js/core/version.js + ?v= dans index.html
const SHELL_CACHE = `shell-${VERSION}`;
const SHARE_CACHE = 'share-inbox'; // hors purge : survit aux changements de VERSION
const V = '?v=2026-08-29a-ho094'; // query des assets versionnés (sync index.html)
const SHELL = [
  './', './index.html',
